...
Image pages show public, localized lock reasons. Staff can lock an entire image or an immutable manifest digest. Digest
locks include tag aliases and referenced multi-architecture content. Write locks freeze changes; read locks retain
metadata for staff and collaborators while blocking downloads and mounts for everyone. System and inherited locks remain
until their source is released. A page refresh after a lock change is discarded if you have navigated away.
