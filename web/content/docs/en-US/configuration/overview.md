...
Other [OAuth providers](../security/oauth-login.md) are configured through `server.oauth_providers`. The administrator
editor supplies official presets, writes credentials without returning them, and applies changes to new authorizations
immediately.
