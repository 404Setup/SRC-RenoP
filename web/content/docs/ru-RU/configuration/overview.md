...
Другие [провайдеры OAuth](../security/oauth-login.md) настраиваются в `server.oauth_providers`. Редактор администратора предлагает официальные шаблоны, сохраняет учётные данные без их возврата и сразу применяет изменения к новой авторизации.
