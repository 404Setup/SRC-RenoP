...
[Справочник API](/api) описывает точки входа для администрирования, интеграции клиентов и мониторинга сервиса. Исходная спецификация [OpenAPI](/assets/openapi.yaml) также доступна для скачивания.
