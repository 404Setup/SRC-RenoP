...
Задачи проверки отправляют подходящим проверяющим дедуплицированные сообщения `review_pending`. Первое решение удаляет
остальные копии проверяющих и отправляет заявителю один локализованный `review_result` без личности проверяющего.
