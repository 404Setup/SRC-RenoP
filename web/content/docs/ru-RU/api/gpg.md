...
## Список публикаций в карантине

- **Путь**: `GET /api/auth/profile/gpg/releases`
- **Назначение**: возвращает артефакты в `.renop.tmp.gpg`, ожидающие отделённую подпись, проверку ключа или
  окончательную
  публикацию.
