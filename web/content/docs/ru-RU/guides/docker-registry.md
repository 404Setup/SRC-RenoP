...
Страницы образов показывают публичные переведённые причины блокировки. Сотрудники могут блокировать весь образ или неизменяемый дайджест манифеста вместе с тегами-псевдонимами и связанным многоархитектурным содержимым. Блокировка записи запрещает изменения; блокировка чтения оставляет метаданные сотрудникам и участникам, запрещая загрузки и монтирование всем. Системные и унаследованные ограничения снимаются у источника. Результат обновления после изменения блокировки отбрасывается, если вы уже покинули страницу.
