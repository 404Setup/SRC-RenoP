...
- Format services владеют Maven domains/catalogs, npm packuments, Cargo Sparse Index, Docker Distribution v2 и doc
  viewers.
- Database layer предоставляет dialect-aware transactions для SQLite, MySQL, PostgreSQL и ClickHouse.
