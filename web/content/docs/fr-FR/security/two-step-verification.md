...
La connexion par Passkey, le second facteur et l’enregistrement affichent un compte à rebours sur le bouton utilisé. Chaque demande native attend au maximum 60 secondes, ou moins si le serveur le demande. L’expiration annule la demande et termine cette tentative de connexion, y compris le second facteur en attente ; les identifiants reçus après le délai sont ignorés. Recommencez la connexion pour réessayer. Quitter la page annule aussi les demandes inachevées. L’annulation, les identifiants indisponibles ou refusés, les environnements incompatibles ou non sécurisés, les doublons et les exigences de vérification non satisfaites affichent des messages traduits sans exposer les exceptions du navigateur.
