...
export default {
    ...
    "download.x64InfoTitle": "x64 Architecture Information",
    ...
    "download.x64V2Desc": "Compatible with Intel Nehalem (2008), AMD Bulldozer (2011), and newer processors (with SSE4.2 and POPCNT).",
    "download.x64V3Desc": "Recommended for modern servers and desktops (Intel Haswell / AMD Zen 2 and newer with AVX2).",
    "download.x64V4Desc": "For high-performance servers with AVX-512 hardware support (e.g. Intel Skylake-X/Ice Lake, AMD Zen 4+).",
    "download.x64AdviceTitle": "Selection Guidance",
    "download.x64AdviceDesc": "For recent servers and workstations, choose v3 for optimal throughput. Choose v1 if you need portable binaries across heterogeneous environments.",
