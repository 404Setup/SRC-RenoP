...
func clickHouseSchemas() []clickHouseTableSchema {
	return []clickHouseTableSchema{
		...
		{name: "user_email_changes", keyColumns: []string{"user_id"}, columns: []string{
			...
			"`attempts` Int32", "`created_at` Int64", "`expires_at` Int64", "`is_alias` Int32 DEFAULT 0",
		}},
		...
		{name: "resource_lock_versions", keyColumns: []string{"lock_id", "source", "version"}, columns: []string{
			"`lock_id` String", "`source` String", "`version` String",
		}},
		{name: "resource_locks", keyColumns: []string{"id", "source"}, columns: []string{
			...
			"`reason` String", "`reason_text` String DEFAULT ''", "`locked_at` Int64",
		}},
		...
		{name: "maven_domains", keyColumns: []string{"repository", "domain"}, columns: []string{
			...
			"`health_checked_at` Int64 DEFAULT 0",
			"`health_next_check_at` Int64 DEFAULT 0",
			"`health_expires_at` Int64 DEFAULT 0",
			"`health_locked_at` Int64 DEFAULT 0",
			"`health_release_at` Int64 DEFAULT 0",
			"`health_lock_reason` String DEFAULT ''",
		}},
		...
		{name: "maven_artifacts", keyColumns: []string{"repository", "group_id", "artifact_id"}, columns: []string{
			...
			"`created_at` Int64", "`updated_at` Int64", "`reclaim_hold_at` Int64 DEFAULT 0",
		}},
