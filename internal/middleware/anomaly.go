...
func isFrontendShellOrAssetPath(reqPath string) bool {
	...
	if cleaned == "/account/login" || cleaned == "/account/recovery" || cleaned == "/account/forgot-password" || cleaned == "/account/reviews" || cleaned == "/account/teams" || cleaned == "/account/maven-domains" {
		return true
	}
