...
export default Object.freeze({
    ...
    "review.teamCreationApproval": "Одобрение команды {team}", "review.repositoryCreationApproval": "Одобрение репозитория после одобрения команды",
    "review.approveCreationConfirm": "Одобрить создание {resource}?",
    "review.rejectCreationTitle": "Отклонить создание пакета",
    "review.creationApproved": "Создание пакета одобрено.", "review.creationRejected": "Создание пакета отклонено.",
