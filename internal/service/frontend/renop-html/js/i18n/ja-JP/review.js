...
export default Object.freeze({
    ...
    "review.transferOwnership": "所有権を移管", "review.transferIn": "グローバルチームへ移管",
    "review.transferOut": "個人所有へ戻す", "review.targetTeam": "移管先グローバルチーム",
    ...
    "review.submitRequest": "申請を送信", "review.selectTeam": "移管先チームを選択してください。", "review.requestSubmitted": "移管申請を送信しました。",
    "review.status.pending": "審査中", "review.status.approved": "承認済み", "review.status.rejected": "拒否済み",
    "review.status.cancelled": "取消済み", "review.status.all": "すべての状態",
    "review.directionIn": "{team} へ移管", "review.directionOut": "{team} から個人所有へ戻す",
    "review.requestedBy": "申請者: {name}", "review.decidedBy": "処理者: {name}",
    "review.assignedToMe": "処理できる審査", "review.requestedByMe": "自分の申請",
    "review.pageSummary": "{page}/{pages} ページ · 全 {total} 件", "review.approve": "承認", "review.reject": "拒否",
    "review.rejectTitle": "移管申請を拒否", "review.rejectReason": "理由", "review.reasonRequired": "拒否理由を入力してください。",
    "review.approveConfirm": "{resource} の所有権移管を承認しますか？", "review.approved": "移管を承認しました。",
    "review.rejected": "移管を拒否しました。", "review.cancelRequest": "申請を取消", "review.cancelConfirm": "この申請を取り消しますか？",
    "review.cancelled": "申請を取り消しました。", "review.empty": "該当する審査はありません", "review.emptyHint": "チームへの新しい申請がここに表示されます。",
    "review.loadFailed": "審査を読み込めませんでした。", "review.operationFailed": "審査操作に失敗しました。",
    "review.authenticationRequired": "審査を使用するにはログインしてください。", "review.invalidRequest": "申請内容を確認して再試行してください。",
    "review.resourceChanged": "所有者が変更されたため申請を取り消しました。", "review.alreadyDecided": "別の管理者がすでに処理しました。",
    ...
    "review.teamCreationApproval": "{team} のチーム承認", "review.repositoryCreationApproval": "チーム承認後のリポジトリ承認",
    "review.approveCreationConfirm": "{resource} の作成を承認しますか？",
    "review.rejectCreationTitle": "パッケージ作成を拒否",
    "review.creationApproved": "パッケージ作成を承認しました。", "review.creationRejected": "パッケージ作成を拒否しました。",
