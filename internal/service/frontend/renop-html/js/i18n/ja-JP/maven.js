...
export default {
    ...
    "maven.dnsRoot": "DNS ルート", "maven.account": "アカウント", "maven.codeHidden": "検証コードはドメイン管理者のみ確認できます",
    "maven.updateMemberFailed": "Maven ドメインメンバーを更新できませんでした", "maven.leaveConfirm": "この Maven ドメインチームから退出しますか？",
    "maven.removeMemberConfirm": "{name} をこの Maven ドメインチームから削除しますか？", "maven.removeMemberFailed": "Maven ドメインメンバーを削除できませんでした",
    "maven.invitePlaceholder": "ユーザー名をカンマで区切る", "maven.invite": "招待", "maven.inviteFailed": "Maven ドメインメンバーを招待できませんでした",
    "maven.inviteSent": "Maven ドメインへの招待を送信しました", "maven.teamTitle": "ドメインチーム", "maven.verifyFailed": "所有権の証明が見つかりません。レコードまたはプロフィールを確認し、反映後に再試行してください。",
    "maven.verifySuccess": "Maven ドメインを検証しました", "maven.verifyNow": "所有権を検証", "maven.deleteDomainConfirm": "Maven ドメイン {domain} を削除しますか？",
    ...
    "maven.inviteTitle": "Maven ドメインへの招待", "maven.inviteBody": "{inviter} が Maven ドメイン {domain} に L{level} 権限で招待しました。",
