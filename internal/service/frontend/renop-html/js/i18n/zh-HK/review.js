...
export default Object.freeze({
    ...
    "review.transferOwnership": "轉讓擁有權", "review.transferIn": "轉讓給超級團隊",
    "review.transferOut": "轉回個人擁有", "review.targetTeam": "目標超級團隊",
    ...
    "review.submitRequest": "提交申請", "review.selectTeam": "請選擇目標超級團隊。", "review.requestSubmitted": "轉讓申請已提交。",
    "review.status.pending": "待審核", "review.status.approved": "已批准", "review.status.rejected": "已拒絕",
    "review.status.cancelled": "已取消", "review.status.all": "全部狀態",
    "review.directionIn": "轉讓給 {team}", "review.directionOut": "由 {team} 轉回個人擁有",
    "review.requestedBy": "由 {name} 申請", "review.decidedBy": "由 {name} 處理",
    "review.assignedToMe": "可處理的審核", "review.requestedByMe": "我的申請",
    "review.pageSummary": "第 {page}/{pages} 頁 · 共 {total} 項審核", "review.approve": "批准", "review.reject": "拒絕",
    "review.rejectTitle": "拒絕轉讓申請", "review.rejectReason": "理由", "review.reasonRequired": "請輸入拒絕理由。",
    "review.approveConfirm": "確定批准 {resource} 的擁有權轉讓？", "review.approved": "轉讓已批准。",
    "review.rejected": "轉讓已拒絕。", "review.cancelRequest": "取消申請", "review.cancelConfirm": "確定取消此轉讓申請？",
    "review.cancelled": "轉讓申請已取消。", "review.empty": "沒有符合條件的審核", "review.emptyHint": "團隊的新申請會顯示在此處。",
    "review.loadFailed": "載入審核失敗。", "review.operationFailed": "審核操作失敗。",
    "review.authenticationRequired": "請先登入再使用審核功能。", "review.invalidRequest": "請檢查審核申請後再試。",
    "review.resourceChanged": "資源擁有權已改變，此申請已取消。", "review.alreadyDecided": "另一位管理員已處理此審核。",
    ...
    "review.teamCreationApproval": "等待 {team} 團隊批准", "review.repositoryCreationApproval": "團隊批准後等待儲存庫審核",
    "review.approveCreationConfirm": "批准建立 {resource}？",
    "review.rejectCreationTitle": "拒絕建立套件",
    "review.creationApproved": "已批准建立套件。", "review.creationRejected": "已拒絕建立套件。",
