...
| Account security / recovery / retirement / tokens / administration | `js/account-security.js`, `js/profile-email-verification.js`, `js/account-recovery.js`, `js/password-recovery.js`, `js/login-route.js`, `js/account-retirement.js`, `js/api-tokens.js`, `js/users/` |
...
`.github/actions/setup-go-runtime/` (404Setup/go), `package.json` (pnpm pin), `.github/workflows/build.yml`
(Node/protoc).
